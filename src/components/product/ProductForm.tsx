...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  return (
    <div className="w-full max-w-xl mx-auto bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden animate-fadeIn flex flex-col max-h-[88dvh] sm:max-h-[85vh] my-auto">
      {/* Header */}
      <div className="px-5 sm:px-6 py-4 bg-slate-900 text-white flex items-center justify-between flex-shrink-0">
        ...
        <span className="text-xs font-mono font-medium px-2.5 py-1 rounded-md bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 flex-shrink-0">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0 overflow-hidden">
        ...
        {/* Submit Actions */}
        <div className="p-4 sm:p-5 bg-slate-50/90 border-t border-slate-200 flex items-center gap-3 flex-shrink-0">
          <button
            type="button"
            onClick={onCancel}
            className="w-1/3 py-3 px-4 bg-white hover:bg-slate-100 border border-slate-200 text-slate-700 font-semibold text-xs rounded-xl transition-colors"
          >
            Cancelar
          </button>
